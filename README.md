...
### شاشة الطبيب / البوابة
- عرض التقارير الطبية
- إدارة المواعيد والأدوية
- تواصل مباشر مع مقدم الرعاية

### 📣 دليل الأوامر الصوتية

- راجع أوامر المساعد الصوتي كاملة هنا: [voice_commands_guide.md](voice_commands_guide.md)
...
[MIT License](LICENSE) - راجع ملف التراخيص للتفاصيل
