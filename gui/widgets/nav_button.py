...
نظام تشغيل الروبوت الطبي الذكي - عنصر زر التنقل

A custom navigation button with icon and text support.
زر تنقل مخصص مع دعم الأيقونات والنص.
"""
...
class SidebarNav(ctk.CTkFrame):
    ...
    def _create_layout(self):
        ...
        self.logo_text.pack(side="right")
    ...
    def _on_button_click(self, key: str):
        ...
        if self.current_key and self.current_key in self.buttons:
            self.buttons[self.current_key].set_active(False)
...
class QuickActionButton(ctk.CTkButton):
    ...
    زر الإجراء السريع للشاشة الرئيسية
    """
