...
sudo apt install -y libglib2.0-0 libgl1 libglx-mesa0 portaudio19-dev libespeak-dev ffmpeg
...
| "تحديث العلامات" | تحديث فوري للبيانات |
...
المشروع يخضع لترخيص **[MIT License](LICENSE)**. يمكنك استخدامه، تعديله، وتوزيعه حتى في المشاريع التجارية، بشرط الإشارة للمؤلف الأصلي.
